...
# situation 1
#t1 = -1.
#t2 = -.4*np.exp(0.5j*np.pi)
#t3 = .33
# situation 2
t1 = -1.
t2 = -.6*np.exp(0.4j*np.pi)
t3 = .58
...
my_model.set_hop(t2, 0, 0, [-1, 1])
my_model.set_hop(t2, 0, 0, [ 0,-1])
my_model.set_hop(t2, 1, 1, [ 1,-1])
my_model.set_hop(t2, 1, 1, [ 0, 1])
my_model.set_hop(t2, 1, 1, [-1, 0])
# add third neighbour hoppings
